...
- Name: fluxo-completo.spec.ts >> Fluxo cliente → profissional → admin >> admin vê pedidos de teste no painel
- Location: tests/e2e/fluxo-completo.spec.ts:33:2
            ...
            - generic [ref=e34]:
                - generic [ref=e35]:
                    - generic [ref=e36]:
                        ...
                        - generic [ref=e37]:
                            - img [ref=e38]
                            - textbox "seu@email.com" [ref=e41]: admin-teste@example.com
                    - generic [ref=e42]:
                        - text: Senha
                        - generic [ref=e43]:
                            - img [ref=e44]
