-- Migration: 20260519204000_fix_criar_repasse_profissional_pendente.sql
...
BEGIN
  ...
  -- 2. Buscar pagamento usando colunas reais
  SELECT 
    id,
    orcamento_id,
    cliente_id,
  ...
  -- 4. Buscar proposta aceita separadamente em public.propostas
