      ...
      <div className="grid grid-cols-2 gap-2">
        {checkinEm ? (
          <div className="flex items-center gap-1.5 text-emerald-700 text-xs font-semibold">
            <CheckCircle2 className="h-3.5 w-3.5" /> Chegou{" "}
            {new Date(checkinEm).toLocaleTimeString("pt-BR", {
              hour: "2-digit",
              minute: "2-digit",
            })}
          </div>
        ...
        {checkoutEm ? (
          <div className="flex items-center gap-1.5 text-emerald-700 text-xs font-semibold">
            <CheckCircle2 className="h-3.5 w-3.5" /> Saiu{" "}
            {new Date(checkoutEm).toLocaleTimeString("pt-BR", {
              hour: "2-digit",
              minute: "2-digit",
            })}
          </div>
