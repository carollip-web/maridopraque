...
import { Search, HelpCircle, MessageCircle, FileQuestion, ShieldCheck, CreditCard, Wrench, ChevronDown } from "lucide-react";
...
const faqs = [
  ...
  },
  {
    ...
    icon: ShieldCheck,
    questions: [
      { q: "Como é feita a verificação dos profissionais?", a: "Todos passam por checagem de antecedentes criminais, verificação de documentos e referências técnicas. Só enviamos profissionais com 100% de aprovação." },
      { q: "O que é o serviço com acompanhante feminina?", a: "É um protocolo onde o técnico homem realiza o serviço pesado enquanto uma colaboradora mulher acompanha todo o processo para garantir seu conforto e segurança." },
    ]
  },
  {
    category: "Pagamentos",
    icon: CreditCard,
    questions: [
      { q: "Quais as formas de pagamento?", a: "Aceitamos Pix (com 5% de desconto), Cartão de Crédito (até 10x sem juros) e Débito presencial." },
      { q: "Preciso pagar antes do serviço?", a: "Não necessariamente. Você pode pagar ao final do serviço ou usar nosso simulador para pagar antecipadamente e garantir seu horário." },
    ]
  },
  {
    category: "Serviços",
    icon: Wrench,
    questions: [
      { q: "Os materiais estão inclusos no preço?", a: "Geralmente não. Nossos orçamentos focam na mão de obra especializada. Caso precise que compremos o material, cobraremos uma taxa de deslocamento e o valor da nota fiscal." },
      { q: "Qual o tempo de garantia?", a: "Oferecemos 30 dias de garantia total para qualquer serviço executado. Se houver qualquer problema, voltamos e resolvemos sem custo adicional." },
    ]
  }
];
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-24">
          ...
          <div key={cat.category}>
            ...
            <div className="space-y-3">
              {cat.questions.map((item, idx) => {
                ...
                return (
                  <div key={id} className="rounded-2xl border border-border bg-card overflow-hidden transition-all hover:border-brand/20">
                    <button 
      ...
      <div className="mt-24 rounded-3xl bg-cream p-10 text-center border border-brand/10">
        ...
        <p className="mt-3 text-muted-foreground">Fale diretamente com um consultor humano no WhatsApp. Estamos online agora.</p>
        <a 
